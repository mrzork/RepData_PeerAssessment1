...
> It was found that the average total steps per day is __`r mea`__ and median steps per day is is __`r med`__.
...
> With each 5-minute interval, along all the time assessed that interval contains the maximum number of steps and found that the 5-minute interval number __`r max`__ is the one that contains the largest number of steps along every day.
...
The total number of missing data is  __`r QtNas`__.
...
> average total steps per day is __`r me2`__  and median steps per day is __`r med2`__.
